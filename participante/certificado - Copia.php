...
//    include "../db.php"; // local
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            echo "<br>" . $row['nome_evento'] . "<a href='/participante/certificado.php?gerar=1&evento=" . $row['id_evento'] . "'>Gerar certificado</a>";
        }
    } 
    ...
    if ($result2->num_rows > 0) {
        ...
        while ($row = $result2->fetch_assoc()) {
            echo "<br><a href='/participante/certificado.php?visualizar=" . $row['id_certificado'] . "'>" . $row['nome_evento'] . "</a>";
        }
    } 
}
