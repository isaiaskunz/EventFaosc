...
<?php 
    ...
    <div class="container row" >
        <div class="event-logo col-2">
            <a href="index.php">
                <img src= "img/logofaosc.png" class="img-responsive img-fluid" width="70%" height="70%">
            </a>
        </div>
        <div class="event-logo col-10">
            <!--<h1> Eventos Faosc  </h1> -->
            <img src="img/portal_eventos.png" class="img-responsive img-fluid" width="25%" height="25%" alt="Logo do evento">
        </div>
        </div>
    </div>
    <div class="nav row">
